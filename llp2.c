...
else if(strcmp(input, "R") == 0) // Add this condition for "R"
{

    char externalsymbols[100][100];
    int externaladdresses[100];



    fscanf(fp1, "%s", externalsymbols[record]); // Read external symbol
    fscanf(fp1, "%x", &externaladdresses[record]); // Read corresponding address
